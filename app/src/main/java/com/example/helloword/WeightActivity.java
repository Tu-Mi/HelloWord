...
public class WeightActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.but_rate:
                Log.d("rate", "onClick: ");
                Intent intent0=new Intent(WeightActivity.this, RateActivity.class);
                startActivity(intent0);
                break;
            case R.id.but_cal:
                Log.d("rate", "onClick: ");
                Intent intent1=new Intent(WeightActivity.this, MainActivity.class);
                startActivity(intent1);
                break;
            case R.id.but_sys:
                Log.d("sys", "onClick: ");
                Intent intent2=new Intent(WeightActivity.this, SystemActivity.class);
                startActivity(intent2);
                break;
            case R.id.but_unit:
                Log.d("unit", "onClick: ");
                Intent intent3=new Intent(WeightActivity.this, UnitActivity.class);
            ...
            case R.id.convert:
            {
                if (spinner1.getSelectedItem().toString().equals("吨")
                ) {
                    if(spinner2.getSelectedItem().toString().equals("千克")) {
                    ...
                    }else  if(spinner2.getSelectedItem().toString().equals("克")) {

                        double i = Double.valueOf(et.getText().toString()).doubleValue();
                        BigDecimal bg = new BigDecimal(i / 1000000.0 + "");
                        con_tv.setText(String.valueOf(bg));
                    }else  if(spinner2.getSelectedItem().toString().equals("毫克")) {

                        double i = Double.valueOf(et.getText().toString()).doubleValue();
                        BigDecimal bg = new BigDecimal(i/ 1000000000.0 + "");
                        con_tv.setText(String.valueOf(bg));
                    }
                    else{
                        double i = Double.valueOf(et.getText().toString()).doubleValue();
                ...
                }else  if (spinner1.getSelectedItem().toString().equals("千克")
                ) {
                    if(spinner2.getSelectedItem().toString().equals("吨")) {
                ...
                }else  if (spinner1.getSelectedItem().toString().equals("克")
                ) {
                    if(spinner2.getSelectedItem().toString().equals("吨")) {
                        ...
                        BigDecimal bg = new BigDecimal(i / 1000000.0 + "");
                        con_tv.setText(String.valueOf(bg));
                    }else  if(spinner2.getSelectedItem().toString().equals("千克")) {
                ...
                }else  if (spinner1.getSelectedItem().toString().equals("毫克")
                ) {
                    if(spinner2.getSelectedItem().toString().equals("克")) {
                        ...
                        BigDecimal bg = new BigDecimal(i / 1000000.0 + "");
                        con_tv.setText(String.valueOf(bg));
                    }else  if(spinner2.getSelectedItem().toString().equals("吨")) {
